...
class TestSecretEntry:
    def test_secret_entry_locking(self):
        ...
        assert secret.get_content() == "******** [LOCKED] ********"
    ...
    def test_secret_entry_unlock(self):
        ...
        assert secret.verify("wrongpass") == False
        assert secret.verify("mypassword") == True
...
class TestStorageFactory:
    def test_factory_text_entry(self):
        ...
        entry = StorageFactory.create("TEXT", {"title": "Test", "body": "Content"})
